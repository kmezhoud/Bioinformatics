...
write.table(cancer_type_summary_freq, file = "data/cytoscape_input/new_version/Cancer-frequency.NA")
head(cancer_type_summary_freq)

```

##### Gene Alteration Frequency by Cancer Type
...
We have to search manually which Lung cancer study has mRNa expression data. 
...
**Do the same [steps](#gene-alteration-frequency-by-cancer-type) for the 4 other Cancer Type: Ovarian Cancer, Invasive Breast, Uterine Endometrioid Carcinoma Carcinoma, Skin Cancer, Non-Melanoma ** 


Cancatenate the *gene_cancer_freq_Lung, gene_cancer_freq_Ovarian, gene_cancer_freq_Breast, gene_cancer_freq_Lung_Uterine, gene_cancer_freq_Skin* with *correlated_genes.EA* objects of Edge Attributions.

```{r}
correlation_cancer.EA <- c(correlated_genes.EA, gene_cancer_freq_Lung)

write.table(correlation_cancer.EA, file = "data/cytoscape_input/new_version/Correlation+Cancer.NA")
